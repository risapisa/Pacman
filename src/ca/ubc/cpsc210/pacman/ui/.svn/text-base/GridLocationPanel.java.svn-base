...
public class GridLocationPanel extends JPanel {
	...
	// Modifies: this
	// Effects:  remembers g and sets the preferred size of the grid location for drawing
	...
	public void paint(Graphics g) {
		...
		if (gridLocation.hasSprite()) {
			Sprite p = gridLocation.getPacman();
			Sprite r = gridLocation.getMonster();
			Sprite t = gridLocation.getMonster();
